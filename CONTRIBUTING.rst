...
----------------------------------
1. Check that you have the latest version of :code:`zenodo_client`
2. Check that StackOverflow hasn't already solved your problem
3. Go here: https://github.com/cthoyt/zenodo-client/issues
...
.. code-block:: sh
    ...
    $ git clone https://github.com/<YourUsername>/zenodo-client
...
If you spend a while working on your changes, further commits may be made to the main :code:`zenodo_client`
...
.. code-block:: sh
    ...
    $ git remote add upstream https://github.com/cthoyt/zenodo-client
